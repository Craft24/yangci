 	  ...
 	  <!--用于添加的pop up-->
		<div id="add_hidden" class="pop_up">
			      ...
			      <div class="table_margin">
						...
						<form id=form_submit action="do_upload_customer" target="_self" method="post" accept-charset="utf-8" enctype="multipart/form-data">

						<table class=table_update>
						<tr height=35><td>文件:</td><td><input id=userfile type="file" class=userfile name="userfile" size="20" />
						<a target="_blank" href="../../help/help.php#customer_dump"><img src="../../img/help.gif" height="20/"></a>
						</td></tr>
						
						<tr height=35><td colspan=3><input class=button type=submit id=form_button_add value="导入" /></td></tr>
						</table>
						</form>
...
<?php
/*  Customer_dump.php文件的结尾 */
/*  在系统中的位置: ./application/views/customer_dump */
?>
</html>
