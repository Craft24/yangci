...
<script>
	...
	function build_grid_tr_add(in_id){cjTable_tr( 'material_out_list?in_id=new&s=0&dates='+Math.floor(Math.random()*9999+1),////url of data source
 	  ...
 	  <!--用于添加的pop up-->
		<div id="add_hidden" class="pop_up">
			      ...
			      <div class="table_margin">
						...
						<tr  height=35>
						<td>领料类型</td><td><select id='out_type' name=non_production  />
						             <option value='0'>普通领料</option>
									 
									 <option value='2'>实验用零头料</option></select>
						</td></tr>
						<tr height=35>
      ...
      <!--用于添加的pop up--结束 -->
		...
		<div id="correct_hidden" class="pop_up">
		              <div class="div_title">领料更正<div class=title_close>关闭</div></div>
						...
						<tr height=35>
						<td>委外供应商</td><td><input type=text id=correct_supplier_name name=supplier_name class=supplier placeholder="如果发给委外供应商,请点击" /><input type=hidden id=correct_supplier_id name=supplier_id class=supplier_id /></td></tr>
						<tr height=35>
