...
<title>物料管理系统</title>
	...
	var base_url='<?php echo base_url();?>';
     ...
     $(function()
	    {	
		   var report_url='product_inventory_print?report_type=f&s=0&dates='+Math.floor(Math.random()*9999+1)
		   var head_string='ID,品名,规格,规格2,批号,状态,库存,单位,类型,盘点数量,复盘人,盘赢,盘亏';////表格标题
		   var hide_string='in_id';
		   var report_head="成品盘点";
