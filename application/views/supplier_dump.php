 ...
 * supplier_dump.php 供应商资料导入工具的视图
 *
 * @category	settings 
 * @源代码
 */
 	  ...
 	  <!--用于添加的pop up-->
		<div id="add_hidden" class="pop_up">
			      ...
			      <div class="table_margin">
						...
						<form id=form_submit action="do_upload_supplier" target="_self" method="post" accept-charset="utf-8" enctype="multipart/form-data">

						<table class=table_update>
						<tr height=35><td>文件:</td><td><input id=userfile type="file" class=userfile name="userfile" size="20" /></td></tr>
